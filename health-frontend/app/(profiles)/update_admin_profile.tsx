...
//                 // const response = await fetch('your-api-endpoint/admin/profile');
...
//                     });
//                     setProfileImage(require('../../assets/images/admin_avatar.jpeg'));
//                     setLoading(false);
//                 }, 800);
//             } catch (error) {
...
//             // }
//             //
//             // await fetch('your-api-endpoint/admin/profile', {
//             //     method: 'POST',
//             //     body: formDataToSend,
//             //     headers: {
...
//                                     <Text style={styles.infoBoxTitle}>Access Level Information</Text>
//                                 </View>
//                                 <Text style={styles.infoBoxText}>
//                                     Your admin access level is set by the super administrator. Contact them if you need different permissions.
//                                 </Text>
//                             </View>

//                             <View style={styles.accessLevelContainer}>
//                                 <Text style={styles.accessLevelLabel}>Current Access Level:</Text>
//                                 <View style={styles.accessLevelBadge}>
//                                     <Text style={styles.accessLevelText}>System Administrator</Text>
//                                 </View>
//                             </View>
...
//                                 <View style={styles.permissionItem}>
//                                     <Ionicons name="checkmark-circle" size={20} color="#38A169" />
//                                     <Text style={styles.permissionText}>Report Generation</Text>
//                                 </View>
//                                 <View style={styles.permissionItem}>
//                                     <Ionicons name="checkmark-circle" size={20} color="#38A169" />
//                                     <Text style={styles.permissionText}>Data Management</Text>
//                                 </View>
//                             </View>
//                         </View>
...
//                                 onPress={() => Alert.alert('Password Reset', 'You will receive an email with instructions to reset your password.')}
//                             >
...
//                                 onPress={() => Alert.alert('Two-Factor Authentication', 'You will be redirected to set up 2FA on your next login.')}
//                             >
//                                 <Ionicons name="shield-checkmark" size={20} color="#3182CE" />
//                                 <Text style={styles.securityButtonTextSecondary}>Enable Two-Factor Authentication</Text>
//                             </TouchableOpacity>
//                         </View>
