    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.categories}>
          {['All', 'Reports', 'Prescriptions', 'Bills'].map((category) => (
            <TouchableOpacity 
              key={category}
        ...
        {[1, 2, 3].map((item) => (
          ...
          >
            ...
            <View style={styles.doctorInfo}>
              <Ionicons name="document-text-outline" size={20} color="#0D3EED" />
            ...
            <View style={styles.recordFooter}>
              ...
              <TouchableOpacity style={styles.downloadButton}>
                <Ionicons name="download-outline" size={20} color="#0D3EED" />
