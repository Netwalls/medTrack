      ...
      <View style={styles.content}>
        ...
        <View style={styles.quickConsult}>
          <View style={styles.quickConsultContent}>
            <Text style={styles.quickConsultText}>We will assign quick and best doctor</Text>
            <TouchableOpacity style={styles.consultButton}>
              <Text style={styles.consultButtonText}>Quick Consult</Text>
            </TouchableOpacity>
          </View>
        </View>
            ...
            <View style={styles.appointmentHeader}>
              <View style={styles.doctorInfoContainer}>
                ...
                <View style={styles.doctorTextInfo}>
                  ...
                  <Text style={styles.speciality}>Skin Specialist | XYZ Hospital</Text>
                  <View style={styles.consultationType}>
                    <Ionicons name="videocam" size={16} color="white" />
                    <Text style={styles.consultationText}>Video Consultation</Text>
                  </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.specialityScroll}>
            {[
              ...
              <TouchableOpacity key={specialty.name} style={styles.specialityItem}>
                <View style={styles.specialityIcon}>
                  <Text style={styles.specialityIconText}>{specialty.icon}</Text>
                </View>
                <Text style={styles.specialityName}>{specialty.name}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
                ...
                <View key={index} style={styles.doctorCard}>
                  ...
                  <TouchableOpacity style={styles.favoriteButton}>
                    <Ionicons 
                      ...
                      size={24} 
                      color={doctor.isFavorite ? "#FF0000" : "#666"} 
                    />
                  </TouchableOpacity>
                </View>
              ))}
